...
unarchiver.o: unarchiver.c 
	gcc -c -g unarchiver.c  -o ./bin/unarchiver.o

haffman_tree_restorer.o: haffman_tree_restorer.c 
	gcc -c -g haffman_tree_restorer.c -o ./bin/haffman_tree_restorer.o

haffman_tree_packer.o: haffman_tree_packer.c
	gcc -c -g haffman_tree_packer.c -o ./bin/haffman_tree_packer.o

haffman_tree_builder.o: haffman_tree_builder.c
	gcc -c -g haffman_tree_builder.c -o ./bin/haffman_tree_builder.o

stack.o: stack.c
	gcc -c -g stack.c -o ./bin/stack.o
unpack.o: unpack.c
	gcc -c -g unpack.c -o ./bin/unpack.o

pack.o: pack.c
	gcc -c -g pack.c -o ./bin/pack.o
